...
class DiagnosisPage extends StatelessWidget {
  ...
  FormGroup _diagnosisFormBuilder(
    ...
    return fb.group({
      'diagnosis_initiated':
          FormControl<String>(value: diagnosisModel?.diagnosisInitiated),
      'first_consultation':
          FormControl<String>(value: diagnosisModel?.firstConsultation),
      'first_consultation_date':
          FormControl<DateTime>(value: diagnosisModel?.firstConsultationDate),
      'chest_xray': FormControl<String>(value: diagnosisModel?.chestXray),
      'chest_xray_date':
          FormControl<DateTime>(value: diagnosisModel?.chestXrayDate),
      'chest_xray_result':
          FormControl<String>(value: diagnosisModel?.chestXrayResult),
      'afb_done': FormControl<String>(value: diagnosisModel?.afbDone),
      'afb_lab_number':
          FormControl<String>(value: diagnosisModel?.afbLabNumber),
      'afb1_result': FormControl<String>(
          value: afb1ResultName ?? diagnosisModel?.afb1Result),
      'afb1_result_date':
          FormControl<DateTime>(value: diagnosisModel?.afb1ResultDate),
      'afb2_result': FormControl<String>(
          value: afb2ResultName ?? diagnosisModel?.afb2Result),
      'afb2_result_date':
          FormControl<DateTime>(value: diagnosisModel?.afb2ResultDate),
      'naat_test': FormControl<String>(value: diagnosisModel?.naatTest),
      'naat_machine': FormControl<String>(
          value: naatResultName ?? diagnosisModel?.naatMachine),
      'naat_site': FormControl<String>(value: diagnosisModel?.naatSite),
      'naat_lab_number':
          FormControl<String>(value: diagnosisModel?.naatLabNumber),
      'sample_collection_date':
          FormControl<DateTime>(value: diagnosisModel?.sampleCollectionDate),
      'naat_result_date':
          FormControl<DateTime>(value: diagnosisModel?.naatResultDate),
      'mtb_result': FormControl<String>(
          value: mtbResultName ?? diagnosisModel?.mtbResult),
      'rif_resistance':
          FormControl<String>(value: diagnosisModel?.rifResistance),
      'xdr_done': FormControl<String>(value: diagnosisModel?.xdrDone),
      'xdr_result': FormControl<String>(value: diagnosisModel?.xdrResult),
      'xdr_result_date':
          FormControl<DateTime>(value: diagnosisModel?.xdrResultDate),
      'xdr_lab_number':
          FormControl<String>(value: diagnosisModel?.xdrLabNumber),
      'xdr_site': FormControl<String>(value: diagnosisModel?.xdrSite),
      'inh_resistance':
          FormControl<String>(value: diagnosisModel?.inhResistance),
      'flq_resistance':
          FormControl<String>(value: diagnosisModel?.flqResistance),
      'amk_resistance':
          FormControl<String>(value: diagnosisModel?.amkResistance),
      'kan_resistance':
          FormControl<String>(value: diagnosisModel?.kanResistance),
      'cap_resistance':
          FormControl<String>(value: diagnosisModel?.capResistance),
      'eth_resistance':
          FormControl<String>(value: diagnosisModel?.ethResistance),
      'fnac': FormControl<String>(value: diagnosisModel?.fnac),
      'fnac_date': FormControl<DateTime>(value: diagnosisModel?.fnacDate),
      'fnac_result': FormControl<String>(value: diagnosisModel?.fnacResult),
      'fnac_comments': FormControl<String>(value: diagnosisModel?.fnacComments),
      'usg': FormControl<String>(value: diagnosisModel?.usg),
      'usg_date': FormControl<DateTime>(value: diagnosisModel?.usgDate),
      'usg_result': FormControl<String>(value: diagnosisModel?.usgResult),
      'usg_comments': FormControl<String>(value: diagnosisModel?.usgComments),
      'other_test': FormControl<String>(value: diagnosisModel?.otherTest),
      'other_test_date':
          FormControl<DateTime>(value: diagnosisModel?.otherTestDate),
      'test_name': FormControl<String>(value: diagnosisModel?.testName),
      'other_test_result':
          FormControl<String>(value: diagnosisModel?.otherTestResult),
      'diagnosis': FormControl<String>(value: diagnosisModel?.diagnosis),
      'diagnosis_date':
          FormControl<DateTime>(value: diagnosisModel?.diagnosisDate),
      'diagnosis_comments':
          FormControl<String>(value: diagnosisModel?.diagnosisComments),
      'spirometry': FormControl<String>(value: diagnosisModel?.spirometry),
      'fev': FormControl<double>(value: diagnosisModel?.fev),
      'fec': FormControl<double>(value: diagnosisModel?.fec),
      'ratio': FormControl<double>(value: diagnosisModel?.ratio),
    });
  }
    ...
    if (formGroup.valid) {
      ...
      final diagnosisModel = model.copyWith(
          ...
          firstConsultationDate:
              formData['first_consultation_date'] as DateTime?,
          ...
          spirometry: formData['spirometry'] as String?,
          fec: formData['fec'] as double?,
          fev: formData['fev'] as double?,
          ratio: formData['ratio'] as double?,
          isUpdated: cubit.state.diagnsosisModel?.isUpdated ?? false);
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CaseCubit, CaseState>(
        builder: (context, state) => Scaffold(
            ...
            body:
                (state.isLoading) ||
                        (state.caseWorkedUpon.diagnosis != null &&
                            state.diagnsosisModel == null)
                    ? Center(
                        child: Lottie.asset(
                            ...
                            (BuildContext context, FormGroup formGroup,
                                ...
                                AutofillGroup(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        DateTextInput(
                                                                          ...
                                                                          controlName:
                                                                              'chest_xray_date',
                                                                          label:
                                                                              AppLocalizations.of(context)!.chestXrayDate,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                                                                kPadding * 2),
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.chestXrayResult,
                                                                          options: const [
                                                                            'Normal',
                                                                            'Abnormal'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('chest_xray_result').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                              .control('chest_xray_result')
                                                                              .value,
                                                                        ),
                                                                      ]))),
                                                      const SizedBox(
                                                                      ...
                                                                      children: [
                                                                        PrimaryTextField(
                                                                          formControlName:
                                                                              'afb_lab_number',
                                                                          label:
                                                                              AppLocalizations.of(context)!.afbLabNumber,
                                                                          prefixIcon:
                                                                        ...
                                                                        BlocBuilder<SourceCubit,
                                                                            ...
                                                                            buildWhen: ((previous, current) =>
                                                                                ...
                                                                                previous.diagnosisData != current.diagnosisData),
                                                                            builder: (context, state) {
                                                                              ...
                                                                              return TextFieldWithList(
                                                                                ...
                                                                                label: AppLocalizations.of(context)!.afb1Result,
                                                                                padding: EdgeInsets.zero,
                                                                                prefixIcon: Icons.account_circle_outlined,
                                                                                listData: list,
                                                                                allowMultiSelection: false,
                                                                                onSelected: (value) {
                                                                                  formGroup.control('afb1_result').value = value[0];
                                                                                },
                                                                                emptyString: '',
                                                                              );
                                                                            }),
                                                                        ...
                                                                        DateTextInput(
                                                                          ...
                                                                          controlName:
                                                                              'afb1_result_date',
                                                                          label:
                                                                              AppLocalizations.of(context)!.afb1ResultDate,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                                                                kPadding * 2),
                                                                        BlocBuilder<SourceCubit,
                                                                            ...
                                                                            builder: (context, state) {
                                                                              ...
                                                                              return TextFieldWithList(
                                                                                ...
                                                                                label: AppLocalizations.of(context)!.afb2Result,
                                                                                padding: EdgeInsets.zero,
                                                                                prefixIcon: Icons.account_circle_outlined,
                                                                                listData: list,
                                                                                allowMultiSelection: false,
                                                                                onSelected: (value) {
                                                                                  formGroup.control('afb2_result').value = value[0];
                                                                                },
                                                                                emptyString: '',
                                                                              );
                                                                            }),
                                                                        ...
                                                                        DateTextInput(
                                                                          ...
                                                                          controlName:
                                                                              'afb2_result_date',
                                                                          label:
                                                                              AppLocalizations.of(context)!.afb2ResultDate,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                                                                kPadding * 2),
                                                                      ...
                                                                      children: [
                                                                        PrimaryTextField(
                                                                          formControlName:
                                                                              'fec',
                                                                          label:
                                                                              AppLocalizations.of(context)!.fec,
                                                                          prefixIcon:
                                                                              Icons.account_circle_outlined,
                                                                          keyboardType:
                                                                        ...
                                                                        PrimaryTextField(
                                                                          formControlName:
                                                                              'fev',
                                                                          label:
                                                                              AppLocalizations.of(context)!.fev,
                                                                          prefixIcon:
                                                                              Icons.account_circle_outlined,
                                                                          keyboardType:
                                                                              TextInputType.number,
                                                                      ...
                                                                      children: [
                                                                        BlocBuilder<SourceCubit,
                                                                            ...
                                                                            buildWhen: ((previous, current) =>
                                                                                ...
                                                                                previous.diagnosisData != current.diagnosisData),
                                                                            builder: (context, state) {
                                                                              List<String> list = (state.diagnosisData != null) ? state.diagnosisData!.naatMachine!.map((e) => '${e.name}').toList() : [];
                                                                              if (state.isLoading ?? false) {
                                                                                return const SizedBox(
                                                                                  height: 15,
                                                                                  width: 15,
                                                                              ...
                                                                              return TextFieldWithList(
                                                                                ...
                                                                                label: AppLocalizations.of(context)!.naatMachine,
                                                                                padding: EdgeInsets.zero,
                                                                                prefixIcon: Icons.account_circle_outlined,
                                                                                listData: list,
                                                                                allowMultiSelection: false,
                                                                                onSelected: (value) {
                                                                                  formGroup.control('naat_machine').value = value[0];
                                                                                },
                                                                                emptyString: '',
                                                                              );
                                                                            }),
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.naatSite,
                                                                          options: const [
                                                                            'Internal',
                                                                            'GOV',
                                                                            'Others'
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('naat_site').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                              .control('naat_site')
                                                                        ...
                                                                        PrimaryTextField(
                                                                          formControlName:
                                                                              'naat_lab_number',
                                                                          label:
                                                                              AppLocalizations.of(context)!.naatLabNumber,
                                                                          prefixIcon:
                                                                              Icons.account_circle_outlined,
                                                                        ),
                                                                        const SizedBox(
                                                                        ...
                                                                        DateTextInput(
                                                                          ...
                                                                          controlName:
                                                                              'naat_result_date',
                                                                          label:
                                                                              AppLocalizations.of(context)!.naatResultDate,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                                                                kPadding * 2),
                                                                        BlocBuilder<SourceCubit,
                                                                            ...
                                                                            builder: (context, state) {
                                                                              ...
                                                                              return TextFieldWithList(
                                                                                ...
                                                                                label: AppLocalizations.of(context)!.mtbResult,
                                                                                padding: EdgeInsets.zero,
                                                                                prefixIcon: Icons.account_circle_outlined,
                                                                                listData: list,
                                                                                allowMultiSelection: false,
                                                                                onSelected: (value) {
                                                                                  formGroup.control('mtb_result').value = value[0];
                                                                                },
                                                                                emptyString: '',
                                                                              );
                                                                            }),
                                                                        ...
                                                                        TextFieldWithList(
                                                                          controlName:
                                                                              'rif_resistance',
                                                                          label:
                                                                              AppLocalizations.of(context)!.rifResistance,
                                                                          padding:
                                                                              EdgeInsets.zero,
                                                                          prefixIcon:
                                                                              Icons.account_circle_outlined,
                                                                          ...
                                                                          onSelected:
                                                                              (value) {
                                                                            formGroup.control('rif_resistance').value =
                                                                                value[0];
                                                                          },
                                                                          emptyString:
                                                                              '',
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.xdrDone,
                                                                          options: const [
                                                                            'Yes',
                                                                            'No'
                                                                          ],
                                                                      ...
                                                                      children: [
                                                                        DateTextInput(
                                                                          ...
                                                                          controlName:
                                                                              'xdr_result_date',
                                                                          label:
                                                                              AppLocalizations.of(context)!.xdrResultDate,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                                                                kPadding * 2),
                                                                        PrimaryTextField(
                                                                          formControlName:
                                                                              'xdr_lab_number',
                                                                          label:
                                                                              AppLocalizations.of(context)!.xdrLabNumber,
                                                                          prefixIcon:
                                                                              Icons.account_circle_outlined,
                                                                        ),
                                                                        const SizedBox(
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.xdrSite,
                                                                          options: const [
                                                                            'Internal',
                                                                            'GOV'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('xdr_site').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                              .control('xdr_site')
                                                                        ...
                                                                        BlocBuilder<SourceCubit,
                                                                            ...
                                                                            builder: (context, state) {
                                                                              ...
                                                                              return TextFieldWithList(
                                                                                ...
                                                                                label: AppLocalizations.of(context)!.xdrResult,
                                                                                padding: EdgeInsets.zero,
                                                                                prefixIcon: Icons.account_circle_outlined,
                                                                                listData: list,
                                                                                allowMultiSelection: false,
                                                                                onSelected: (value) {
                                                                                  formGroup.control('xdr_result').value = value[0];
                                                                                },
                                                                                emptyString: '',
                                                                              );
                                                                            }),
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.inhResistance,
                                                                          options: const [
                                                                            'Sensitive',
                                                                            'Resistant'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('inh_resistance').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.flqResistance,
                                                                          options: const [
                                                                            'Sensitive',
                                                                            'Resistant'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('flq_resistance').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.amkResistance,
                                                                          options: const [
                                                                            'Sensitive',
                                                                            'Resistant'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('amk_resistance').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.kanResistance,
                                                                          options: const [
                                                                            'Sensitive',
                                                                            'Resistant'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('kan_resistance').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.capResistance,
                                                                          options: const [
                                                                            'Sensitive',
                                                                            'Resistant'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('cap_resistance').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.ethResistance,
                                                                          options: const [
                                                                            'Sensitive',
                                                                            'Resistant'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('eth_resistance').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                      ...
                                                                      children: [
                                                                        DateTextInput(
                                                                          ...
                                                                          controlName:
                                                                              'other_test_date',
                                                                          label:
                                                                              AppLocalizations.of(context)!.otherTestDate,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                                                                kPadding * 2),
                                                                        PrimaryTextField(
                                                                          formControlName:
                                                                              'test_name',
                                                                          label:
                                                                              AppLocalizations.of(context)!.testName,
                                                                          prefixIcon:
                                                                              Icons.account_circle_outlined,
                                                                        ),
                                                                        const SizedBox(
                                                                        ...
                                                                        ChipRadioButtons(
                                                                          label:
                                                                              AppLocalizations.of(context)!.otherTestResult,
                                                                          options: const [
                                                                            'Normal',
                                                                            'Abnormal'
                                                                          ],
                                                                          ...
                                                                          onChanged:
                                                                              (value) {
                                                                            formGroup.control('other_test_result').value =
                                                                                value;
                                                                          },
                                                                          selected: formGroup
                                                                              .control('other_test_result')
                                                                              .value,
                                                                        ),
                                                                        const SizedBox(
                                                                            height:
                                  ...
                                  BottomButtonBar(
                                    ...
                                    nextPage:
                                        formGroup.control('diagnosis').value ==
                                                'Case Closed TB'
                                            ? const AppHomeRoute()
